...
these files taken together allow a feature to do its thing easily, with the minimum of boilerplate, and withoutregard to the traditional app|api machine boundary.
